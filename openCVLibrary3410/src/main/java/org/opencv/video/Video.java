...
public class Video {
     ...
     *
     * @param templateImage single-channel template_card_1 image; CV_8U or CV_32F array.
     ...
     * correlation coefficient, that is the correlation coefficient between the template_card_1 image and the
